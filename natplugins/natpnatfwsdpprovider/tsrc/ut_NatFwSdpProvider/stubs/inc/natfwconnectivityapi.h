...
public:
     ...
     */
    static CNATFWConnectivityApi* NewL();

    /**
     * Two-phased constructor.
     */
    static CNATFWConnectivityApi* NewLC();
     ...
     */
    TUint CreateSessionL( TUint32 aIap, const TDesC8& aDomain );
     ...
     */
    void LoadPluginL( TUint aSessionId, const CDesC8Array& aPlugins, TInt& aPluginIndex );
...
private: // data
    ...
    TUint iSessionIdBase;
    TUint iStreamIdBase;
    RPointerArray<CNSPWrapper> iWrappers;
