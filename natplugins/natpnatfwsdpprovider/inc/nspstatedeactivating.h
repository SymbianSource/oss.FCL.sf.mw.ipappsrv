...
#ifndef NSPSTATEDEACTIVATING_H
#define NSPSTATEDEACTIVATING_H
 ...
 *  @since S60 3.2
 */
class CNSPStateDeActivating : public CNSPStateBase
    {
public: // Constructors and destructor
     ...
     */
    static CNSPStateDeActivating* NewL();
    
    /**
     * A two-phase constructor.
     */
    static CNSPStateDeActivating* NewLC();
    
    /**
     * Destructor.
     */
    virtual ~CNSPStateDeActivating();


private: // Constructors and destructor

    CNSPStateDeActivating();
