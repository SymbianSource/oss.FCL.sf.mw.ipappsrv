...
public:
	...
	// Changes behavior of subsessionhandle-function
	IMPORT_C void ChangeHandling(TBool aValue);
	// Needed to return different values due to testing
	IMPORT_C TInt SubSessionHandle() const;
	
private:
	
	// should the implementation use our version 
	// or the symbian default
	// this is needed
	TBool iUseBaseClassSubSessionhandle;
	
	// Used to save protocol info
	TInt iProtocol;
	};
