...
CTestSettings::CTestSettings( TUint aIapId )
    ...
    iUdpRefreshInterval = KNATFWDefaultIapRefreshIntervalUdp;
    iTcpRefreshInterval = KNATFWDefaultIapRefreshIntervalTcp;
...
void CTestSettings::CreateSettingsL()
    ...
    */
    StoreL( KNATFWDefaultCRLFRefreshEnabled | domainKey | 
