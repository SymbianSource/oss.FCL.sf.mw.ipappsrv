...
// ---------------------------------------------------------------------------
// CSTUNBindingInit::CSTUNBindingInit
// ---------------------------------------------------------------------------
//
CSTUNBindingInit::CSTUNBindingInit(
...
// ---------------------------------------------------------------------------
//
CSTUNBindingInit::CSTUNBindingInit( const CSTUNBindingInit& aInit ) :
    CSTUNBindingState(),
    iGetSharedSecret( aInit.iGetSharedSecret )
    {    
    }
...
// ---------------------------------------------------------------------------
// CSTUNBindingInit::SendRequestL
// ---------------------------------------------------------------------------
//
void
CSTUNBindingInit::SendRequestL( CBindingImplementation& aContext ) const
    {    
    aContext.GetServerAddressL();
    aContext.ChangeState( iGetSharedSecret );
    aContext.GetSharedSecretL();
    }
