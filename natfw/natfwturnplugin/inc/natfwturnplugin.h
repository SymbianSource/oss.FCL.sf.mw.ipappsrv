...
#ifndef C_NATFWTURNPLUGIN_H
#define C_NATFWTURNPLUGIN_H
 ...
 *
 *  The client uses this interface to send TURN requests. Forwards
 *  client requests to Turn Connection Handler.
 *
 *  @lib turnplugin.lib
 *  @since S60 v3.2
 */
class CNATFWTurnPlugin : public CNATFWPluginApi
    {

public:

    /**
     * Creates a new instance of NAT FW TURN Plug-in class.
     *
     * @since S60 v3.2
     * @param aInitParams Initial parameters that will be given to
     *                    TURN Connection Handler class.
     * @return A new instance, ownership is transferred.
     */
    static CNATFWTurnPlugin* NewL( TAny* aInitParams );
...
private: // data
     ...
     * Own.
     */
    CNATFWTurnConnectionHandler* iTurnConnectionHandler;

    };

#endif // C_NATFWTURNPLUGIN_H
