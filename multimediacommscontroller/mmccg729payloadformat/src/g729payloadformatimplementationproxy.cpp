...
*                resolution for the G729 RTP payload format plugin.
*
*/
...
const TImplementationProxy ImplementationTable[] = 
    {
    IMPLEMENTATION_PROXY_ENTRY( KImplUidG729PayloadFormatDecode, CG729PayloadFormatRead::NewL ),
    IMPLEMENTATION_PROXY_ENTRY( KImplUidG729PayloadFormatEncode, CG729PayloadFormatWrite::NewL )
    };
