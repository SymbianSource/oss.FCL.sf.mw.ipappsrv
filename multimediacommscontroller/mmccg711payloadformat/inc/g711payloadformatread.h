...
* Contributors:
*
* Description:    Reads RTP payload format containing G711 data.
*
*/



#ifndef G711PAYLOADFORMATREAD_H
#define G711PAYLOADFORMATREAD_H
...
// CLASS DECLARATION
/**
*  Depacketizes RTP payload containing G711 data.
*
*  @lib Mccg711plformat.dll
*  @since Series 60 3.0
*/
class CG711PayloadFormatRead : public CPayloadFormatRead, public MPayloadFormatRead
    {
    public:
        ...
        */
        static CG711PayloadFormatRead* NewL( MDataSource* aSource );

        /**
        * Destructor.
        */
        virtual ~CG711PayloadFormatRead();
    ...
    public: // From CMMFFormatDecode
        ...
        /**
        * From CMMFFormatDecode. Gets the number of streams of the specified
        * media type.
        ...
        */
        ...
        /**
        * From CMMFFormatDecode. Returns the time interval for one frame for
    ...
    public: // From MPayloadFormatRead
        ...
        /**
        * Send full sink buffer with G.711 frames to data path.
        ...
        */    
        ...
        /**
        * Fill the sink buffer by decoding the RTP payload into G.711 frames
        * Sink buffer is decided on one of the two frame buffers
        * Called by the state machine.
        * @since Series 60 3.0
        * @param None
    ...
    private:
        ...
        */
        TInt DecodePayload( TDes8& aSourceBuffer );
    ...
    private: // Data
        ...
        // Number of frames expected to receive in RTP payload
        TUint8 iFramesPerPacket;

        // Frame time interval in micro seconds
        TTimeIntervalMicroSeconds iFrameTimeInterval;

        // Buffer to store depacketized G711 frames 
        CMMFDataBuffer* iFrameBufferOne;

        // Alternate buffer to store  depacketized G711 frames
        ...
        TMccCodecInfo iCInfo;      
            ...
            friend class UT_CG711PayloadFormatRead;
        #endif
    };


#endif /* G711PAYLOADFORMATREAD_H */
