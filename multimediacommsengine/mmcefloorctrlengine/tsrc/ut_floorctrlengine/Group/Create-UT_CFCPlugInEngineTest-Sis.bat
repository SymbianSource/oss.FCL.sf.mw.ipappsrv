...
copy %EPOCROOT%epoc32\release\thumb\urel\UT_CFCPlugInEngineTest.dll .
if errorlevel == 1 goto END_ERROR 
...
:MAKESIS
echo.
echo - makesis UT_CFCPlugInEngineTest.pkg ..\sis\UT_CFCPlugInEngineTest.sis
call makesis UT_CFCPlugInEngineTest.pkg ..\sis\UT_CFCPlugInEngineTest.sis
if errorlevel == 1 goto END_ERROR

:DELETE_DLL
echo.
echo - remove the copied dll from current folder
del UT_CFCPlugInEngineTest.dll
goto END
