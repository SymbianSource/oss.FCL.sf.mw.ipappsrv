...
copy %EPOCROOT%epoc32\release\thumb\urel\UT_CFCPlugInTest.dll .
if errorlevel == 1 goto END_ERROR 
...
:MAKESIS
echo.
echo - makesis UT_CFCPlugInTest.pkg ..\sis\UT_CFCPlugInTest.sis
call makesis UT_CFCPlugInTest.pkg ..\sis\UT_CFCPlugInTest.sis
if errorlevel == 1 goto END_ERROR

:DELETE_DLL
echo.
echo - remove the copied dll from current folder
del UT_CFCPlugInTest.dll
goto END
