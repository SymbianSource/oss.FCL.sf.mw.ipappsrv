...
#ifndef CMCESTATEIDLE_H
#define CMCESTATEIDLE_H

#include "mcestate.h"


/**
*  Represents MCE server state Idle
...
*
*/
class CMceStateIdle : public CMceState,
...
private://handler routines
	...
	/**
	* Handles entry of EMceItcEstablishSession
	* @param aEvent transition event
	*/
    void EntryEstablishL( TMceStateTransitionEvent& aEvent );
