...
#ifndef CMCENATSTATEINITIALIZING_H
#define CMCENATSTATEINITIALIZING_H
...
*
*/
class CMceNatStateInitializing : public CMceNatState,
...
#endif // CMCENATSTATEINITIALIZING_H
