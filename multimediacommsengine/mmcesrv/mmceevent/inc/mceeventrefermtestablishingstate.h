...
#ifndef CMCEEVENTREFERMTESTABLISHINGSTATE_H
#define CMCEEVENTREFERMTESTABLISHINGSTATE_H
...
/**
*  MT refer is received and waiting for action from client.
*
*  @lib 
*  @since
*/
class CMceEventReferMtEstablishingState : public CMceEventStateBase
    {
...
#endif      // CMCEEVENTREFERMTESTABLISHINGSTATE_H
