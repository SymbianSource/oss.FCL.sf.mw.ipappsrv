...
#ifndef CMCEEVENTREFERTERMINATINGSTATE_H
#define CMCEEVENTREFERTERMINATINGSTATE_H
...
/**
*  Refer terminating is in progress.
*
*  @lib 
*  @since
*/
class CMceEventReferTerminatingState : public CMceEventStateBase
    {
...
#endif      // CMCEEVENTREFERTERMINATINGSTATE_H
