...
#ifndef __TMCETESTUIENGINECMDCREATEMCESETTINGS_H__
#define __TMCETESTUIENGINECMDCREATEMCESETTINGS_H__
 ...
 * 
 */
class TMCETestUIEngineCmdCreateMceSettings: public TMCETestUIEngineCmdBase
	{
	...
	public:	// Constructors
		 ...
		 */
		TMCETestUIEngineCmdCreateMceSettings( CMCETestUIEngine& aEngine );
		 ...
		 */
		TMCETestUIEngineCmdCreateMceSettings( 
