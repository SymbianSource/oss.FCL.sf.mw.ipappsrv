...
#ifndef __TMCETESTUIENGINECMDRINGINGTSESSION_H__
#define __TMCETESTUIENGINECMDRINGINGTSESSION_H__
 ...
 * 
 */
class TMCETestUIEngineCmdRingingSession: public TMCETestUIEngineCmdBase
	{
	...
	public:	// Constructors
		 ...
		 */
		TMCETestUIEngineCmdRingingSession( 
...
#endif // __TMCETESTUIENGINECMDRINGINGTSESSION_H__
