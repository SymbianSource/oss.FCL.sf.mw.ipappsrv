...
#ifndef __TMCETESTUIENGINECMDCREATEVOIPSESSION_H__
#define __TMCETESTUIENGINECMDCREATEVOIPSESSION_H__
 ...
 * 
 */
class TMCETestUIEngineCmdCreateVoIPSession: public TMCETestUIEngineCmdBase
	{
	...
	public:	// Constructors
		 ...
		 */
		TMCETestUIEngineCmdCreateVoIPSession( CMCETestUIEngine& aEngine );
		 ...
		 */
		TMCETestUIEngineCmdCreateVoIPSession( 
...
#endif // __TMCETESTUIENGINECMDCREATEPOCSESSION_H__
