...
#ifndef __CREATEPOCSESSIONDIALOG_H__
#define __CREATEPOCSESSIONDIALOG_H__
...
class CCreatePoCSessionDialog: public CAknForm
    ...
    public:
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CCreatePoCSessionDialog(TSessionParams* aParams );

       /**
         Destroy the object
        */
        ~CCreatePoCSessionDialog();
