...
#ifndef __CREATESESSIONDIALOG_H__
#define __CREATESESSIONDIALOG_H__ (0x1)
...
class CCreateSessionDialog: public CAknForm
    {
    public:
       /**
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CCreateSessionDialog(TSessionParams* aParams);

       /**
         Destroy the object
        */
        ~CCreateSessionDialog();
