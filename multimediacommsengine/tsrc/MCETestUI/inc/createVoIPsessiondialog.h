...
#ifndef __CREATEVOIPSESSIONDIALOG_H__
#define __CREATEVOIPSESSIONDIALOG_H__
...
class CCreateVoIPSessionDialog: public CAknForm
    ...
    public:
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CCreateVoIPSessionDialog(TSessionParams* aParams );

       /**
         Destroy the object
        */
        ~CCreateVoIPSessionDialog();
