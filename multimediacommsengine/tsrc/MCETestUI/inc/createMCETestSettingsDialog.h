...
#ifndef __CREATEMCETESTSETTINGSDIALOG_H__
#define __CREATEMCETESTSETTINGSDIALOG_H__ (0x1)
...
class CCreateMceSettingsDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateMceSettingsDialog(CMCETestUIEngine& aEngine);

       /**
         Destroy the object
        */
        ~CCreateMceSettingsDialog();
