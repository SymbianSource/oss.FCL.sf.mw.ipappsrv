...
#ifndef __CREATEFILESOURCEDIALOG_H__
#define __CREATEFILESOURCEDIALOG_H__ (0x1)
...
class CCreateAudioFileSourceDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateAudioFileSourceDialog(CMCETestUIEngineAudioStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateAudioFileSourceDialog();
...
class CCreateVideoFileSourceDialog: public CAknForm
    {
    public:
       /**
         Perform the first phase of two phase construction
        @param aParams Receive parameters
        */
         CCreateVideoFileSourceDialog(CMCETestUIEngineVideoStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateVideoFileSourceDialog();
