...
#ifndef __CREATERTPSINKDIALOG_H__
#define __CREATERTPSINKDIALOG_H__ (0x1)
...
class CCreateRtpSinkDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateRtpSinkDialog(CMCETestUIEngineAudioStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateRtpSinkDialog();
