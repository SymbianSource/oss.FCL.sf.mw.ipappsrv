...
#ifndef __CREATECAMERASOURCEDIALOG_H__
#define __CREATECAMERASOURCEDIALOG_H__ (0x1)
...
class CCreateCameraSourceDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateCameraSourceDialog(CMCETestUIEngineVideoStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateCameraSourceDialog();
