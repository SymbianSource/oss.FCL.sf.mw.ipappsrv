...
#ifndef __CREATESPAKERSINKDIALOG_H__
#define __CREATESPAKERSINKDIALOG_H__ (0x1)
...
class CCreateSpeakerSinkDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateSpeakerSinkDialog(CMCETestUIEngineAudioStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateSpeakerSinkDialog();
