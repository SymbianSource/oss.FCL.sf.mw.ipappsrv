...
#ifndef __CREATEVIDEOCODECDIALOG_H__
#define __CREATEVIDEOCODECDIALOG_H__ (0x1)
...
class CCreateVideoCodecDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateVideoCodecDialog(CMCETestUIEngineVideoStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateVideoCodecDialog();
