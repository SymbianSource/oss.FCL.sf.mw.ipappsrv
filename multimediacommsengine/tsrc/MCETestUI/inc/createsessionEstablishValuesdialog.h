...
class CSessionEstablishValuesDialog: public CAknForm
    {
    public:
       /**
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CSessionEstablishValuesDialog(TSessionEstablishValues* aParams);

       /**
         Destroy the object
        */
        ~CSessionEstablishValuesDialog();
    ...
    private:
        ...
        TSessionEstablishValues* iParams;
    };
...
class CSessionResponseValuesDialog: public CAknForm
    {
    public:
       /**
         Perform the first phase of two phase construction
        ...
        */
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CSessionResponseValuesDialog(TSessionResponseValues* aParams);

       /**
         Destroy the object
        */
        ~CSessionResponseValuesDialog();
    ...
    private:
        /** @var iParams Return item after dialog has run, owned by caller */
        TSessionResponseValues* iParams;
    };
/**
