...
#ifndef __CREATEMCETESTVALUESETTINGSDIALOG_H__
#define __CREATEMCETESTVALUESETTINGSDIALOG_H__ (0x1)
...
class CCreateMceValueSettingsDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateMceValueSettingsDialog(CMCETestUIEngine& aEngine);

       /**
         Destroy the object
        */
        ~CCreateMceValueSettingsDialog();
