...
#ifndef __CREATE2WAYVIDEOSESSIONDIALOG_H__
#define __CREATE2WAYVIDEOSESSIONDIALOG_H__
...
class CCreate2WayVideoSessionDialog: public CAknForm
    ...
    public:
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CCreate2WayVideoSessionDialog(TSessionParams* aParams );

       /**
         Destroy the object
        */
        ~CCreate2WayVideoSessionDialog();
...
#endif // __CREATE2WAYVIDEOSESSIONDIALOG_H__
