...
#ifndef __CREATEDISPLAYSINKDIALOG_H__
#define __CREATEDISPLAYSINKDIALOG_H__ (0x1)
...
class CCreateDisplaySinkDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateDisplaySinkDialog(CMCETestUIEngineVideoStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateDisplaySinkDialog();
