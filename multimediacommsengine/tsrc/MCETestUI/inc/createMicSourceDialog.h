...
#ifndef __CREATEMICSOURCEDIALOG_H__
#define __CREATEMICSOURCEDIALOG_H__ (0x1)
...
class CCreateMicSourceDialog: public CAknForm
    {
    public:
       /**
        ...
        */
         CCreateMicSourceDialog(CMCETestUIEngineAudioStream& aStream,TInt aIndex);

       /**
         Destroy the object
        */
        ~CCreateMicSourceDialog();
