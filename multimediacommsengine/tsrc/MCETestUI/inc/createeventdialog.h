...
#ifndef __CREATEEVENTDIALOG_H__
#define __CREATEEVENTDIALOG_H__ (0x1)
...
class CCreateEventDialog: public CAknForm
    {
    public:
       /**
      ...
      //  CCreatePoCSessionDialog( CMCETestUIEngine ::TPoCSessionParams* aParams );
         CCreateEventDialog(TEventParams* aParams);
