...
#ifndef __TCMDGETPROFILES_H__
#define __TCMDGETPROFILES_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetProfiles" functionality.
 */
class TCmdGetProfiles
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetProfiles( MTcTestContext& aContext )
