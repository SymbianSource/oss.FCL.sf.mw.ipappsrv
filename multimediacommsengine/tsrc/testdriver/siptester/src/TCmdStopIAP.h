...
#ifndef __TCMDSTOPIAP_H__
#define __TCMDSTOPIAP_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "StopIAP" functionality.
 */
class TCmdStopIAP
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdStopIAP( MTcTestContext& aContext )
