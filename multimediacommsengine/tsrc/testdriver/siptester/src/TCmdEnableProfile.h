...
#ifndef __TCMDENABLEPROFILE_H__
#define __TCMDENABLEPROFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "EnableProfile" functionality.
 */
class TCmdEnableProfile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdEnableProfile( MTcTestContext& aContext )
