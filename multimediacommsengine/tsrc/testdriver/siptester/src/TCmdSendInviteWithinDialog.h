...
#ifndef __TCMDSENDINVITEWITHINDIALOG_H__
#define __TCMDSENDINVITEWITHINDIALOG_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendInvite" functionality.
 */
class TCmdSendInviteWithinDialog
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendInviteWithinDialog( MTcTestContext& aContext )
...
#endif // __TCMDSENDINVITEWITHINDIALOG_H__
