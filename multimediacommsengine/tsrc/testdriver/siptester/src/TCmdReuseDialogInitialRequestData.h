...
#ifndef __TCMDREUSEDIALOGINITIALREQUESTDATA_H__
#define __TCMDREUSEDIALOGINITIALREQUESTDATA_H__
 ...
 */
class TCmdReuseDialogInitialRequestData
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdReuseDialogInitialRequestData( MTcTestContext& aContext )
