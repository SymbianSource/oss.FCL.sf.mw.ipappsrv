...
#ifndef __TCMDSENDACK_H__
#define __TCMDSENDACK_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendAck" functionality.
 */
class TCmdSendAck
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendAck( MTcTestContext& aContext )
