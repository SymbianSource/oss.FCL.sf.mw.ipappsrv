...
#ifndef __TCMDTERMINATE_H__
#define __TCMDTERMINATE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "Terminate" functionality.
 */
class TCmdTerminate
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdTerminate( MTcTestContext& aContext )
