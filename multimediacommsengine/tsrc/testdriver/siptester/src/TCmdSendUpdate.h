...
#ifndef __TCMDSENDUPDATE_H__
#define __TCMDSENDUPDATE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendUpdate" functionality.
 */
class TCmdSendUpdate
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendUpdate( MTcTestContext& aContext )
