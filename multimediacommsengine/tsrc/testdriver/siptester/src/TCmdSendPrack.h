...
#ifndef __TCMDSENDPRACK_H__
#define __TCMDSENDPRACK_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendPrack" functionality.
 */
class TCmdSendPrack
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendPrack( MTcTestContext& aContext )
