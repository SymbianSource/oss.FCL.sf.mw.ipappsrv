...
#ifndef __TCMDDELETEPROFILE_H__
#define __TCMDDELETEPROFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "DeleteProfile" functionality.
 */
class TCmdDeleteProfile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdDeleteProfile( MTcTestContext& aContext )
