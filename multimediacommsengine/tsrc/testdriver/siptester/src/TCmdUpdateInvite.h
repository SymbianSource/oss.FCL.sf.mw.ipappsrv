...
#ifndef __TCMDUPDATEINVITE_H__
#define __TCMDUPDATEINVITE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "UpdateInvite" functionality.
 */
class TCmdUpdateInvite
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUpdateInvite( MTcTestContext& aContext )
