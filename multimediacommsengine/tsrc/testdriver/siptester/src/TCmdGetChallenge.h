...
#ifndef __TCMDGETCHALLENGE_H__
#define __TCMDGETCHALLENGE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetChallenge" functionality.
 */
class TCmdGetChallenge
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetChallenge( MTcTestContext& aContext )
