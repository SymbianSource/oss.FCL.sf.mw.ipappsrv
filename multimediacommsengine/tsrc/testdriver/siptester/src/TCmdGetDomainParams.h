...
#ifndef TCMDGETDOMAINPARAMS_H
#define TCMDGETDOMAINPARAMS_H
...
// CLASS DEFINITION
/**
 * Command class responsible for getting the configured UNSAF timer values.
 */
class TCmdGetDomainParams
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetDomainParams( MTcTestContext& aContext ) :
