...
#ifndef __TCMDGETDIALOGAOR_H__
#define __TCMDGETDIALOGAOR_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetDialogAOR" functionality.
 */
class TCmdGetDialogAOR
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetDialogAOR( MTcTestContext& aContext )
