...
#ifndef __TCMDTERMINATEPROCESS_H__
#define __TCMDTERMINATEPROCESS_H__
...
class TCmdTerminateProcess
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdTerminateProcess( MTcTestContext& aContext )
	...
	public:	
		void TerminateProcessL(const TDesC& aName);
		TBool IsProcessRunning(const TDesC& aName);

	};

#endif // __TCMDTERMINATEPROCESS_H__
