...
#ifndef __TCMDDESTROYPROFILE_H__
#define __TCMDDESTROYPROFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "DestroyProfile" functionality.
 */
class TCmdDestroyProfile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdDestroyProfile( MTcTestContext& aContext )
...
#endif // __TCMDDESTROYPROFILE_H__
