...
#ifndef __TCMDSENDREFER_H__
#define __TCMDSENDREFER_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendRefer" functionality.
 */
class TCmdSendRefer
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendRefer( MTcTestContext& aContext )
