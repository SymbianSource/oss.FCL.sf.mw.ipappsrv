...
#ifndef __TCMDGETREFRESH_H__
#define __TCMDGETREFRESH_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetRefresh" functionality.
 */
class TCmdGetRefresh
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetRefresh( MTcTestContext& aContext )
