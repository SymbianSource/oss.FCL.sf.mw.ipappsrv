...
#ifndef __TCMDDELETEFILE_H__
#define __TCMDDELETEFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "DeleteFile" functionality.
 */
class TCmdDeleteFile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdDeleteFile( MTcTestContext& aContext )
