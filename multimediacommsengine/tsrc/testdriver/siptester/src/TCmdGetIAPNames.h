...
#ifndef __TCMDGETIAPNAMES_H__
#define __TCMDGETIAPNAMES_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetIAPNames" functionality.
 */
class TCmdGetIAPNames
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetIAPNames( MTcTestContext& aContext )
