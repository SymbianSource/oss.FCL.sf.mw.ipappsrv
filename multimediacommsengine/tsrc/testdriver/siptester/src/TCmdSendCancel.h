...
#ifndef __TCMDSENDCANCEL_H__
#define __TCMDSENDCANCEL_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendCancel" functionality.
 */
class TCmdSendCancel
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendCancel( MTcTestContext& aContext )
