...
#ifndef __TCMDISCANCELALLOWED_H__
#define __TCMDISCANCELALLOWED_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "IsCancelAllowed" functionality.
 */
class TCmdIsCancelAllowed
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdIsCancelAllowed( MTcTestContext& aContext )
...
#endif // __TCMDISCANCELALLOWED_H__
