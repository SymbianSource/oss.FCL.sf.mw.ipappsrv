...
#ifndef __TCMDUPDATEREFER_H__
#define __TCMDUPDATEREFER_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "UpdateRefer" functionality.
 */
class TCmdUpdateRefer
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUpdateRefer( MTcTestContext& aContext )
