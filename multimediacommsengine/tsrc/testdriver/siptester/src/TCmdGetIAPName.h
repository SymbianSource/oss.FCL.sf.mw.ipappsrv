...
#ifndef __TCMDGETIAPNAME_H__
#define __TCMDGETIAPNAME_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetIAPName" functionality.
 */
class TCmdGetIAPName
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetIAPName( MTcTestContext& aContext )
