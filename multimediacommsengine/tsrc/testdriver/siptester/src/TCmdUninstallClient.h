...
#ifndef __TCMDUNINSTALLCLIENT_H__
#define __TCMDUNINSTALLCLIENT_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "UninstallClient" functionality.
 */
class TCmdUninstallClient
	: public TCmdInstallClient
	{
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUninstallClient( MTcTestContext& aContext )
							 : TCmdInstallClient( aContext ) {};
...
#endif // __TCMDUNINSTALLCLIENT_H__
