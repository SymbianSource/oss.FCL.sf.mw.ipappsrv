...
#ifndef __TCMDINSTALLCLIENT_H__
#define __TCMDINSTALLCLIENT_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "InstallClient" functionality.
 */
class TCmdInstallClient
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdInstallClient( MTcTestContext& aContext )
	...
	protected: // New methods
		...
		/// Creates an XML file, used by derived class TCmdUninstallClient also
		void PrepareFileL();

	};

#endif // __TCMDINSTALLCLIENT_H__
