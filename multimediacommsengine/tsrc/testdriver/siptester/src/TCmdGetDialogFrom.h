...
#ifndef __TCMDGETDIALOGFROM_H__
#define __TCMDGETDIALOGFROM_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetDialogFrom" functionality.
 */
class TCmdGetDialogFrom
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetDialogFrom( MTcTestContext& aContext )
