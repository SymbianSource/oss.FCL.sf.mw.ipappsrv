...
#ifndef __TCMDUNREGISTER_H__
#define __TCMDUNREGISTER_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "Unregister" functionality.
 */
class TCmdUnregister
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUnregister( MTcTestContext& aContext )
