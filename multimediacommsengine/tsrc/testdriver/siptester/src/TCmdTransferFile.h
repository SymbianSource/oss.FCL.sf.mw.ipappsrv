...
#ifndef __TCMDTRANSFERFILE_H__
#define __TCMDTRANSFERFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "TransferFile" functionality.
 */
class TCmdTransferFile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdTransferFile( MTcTestContext& aContext )
    ...
    protected: // New methods
		/// Installs file to specified location
        void DoWriteL( TPtrC8& aDestinationPath,
                       TPtrC8& aData );
                       
        /// Copies file from source to destination
        void DoCopyL( TPtrC8& aSourcePath,
                      TPtrC8& aDestinationPath );

		/// Reads file from specified location
        TDesC8 DoReadL( TFileName& aDestinationPath );
        
        TBool CheckFileExists(const TDesC& aFileName);
	};

#endif // __TCMDTRANSFERFILE_H__
