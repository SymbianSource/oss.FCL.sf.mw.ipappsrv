...
#ifndef TCMDSETCLIENTMATCHTYPE_H
#define TCMDSETCLIENTMATCHTYPE_H
...
class TCmdSetClientMatchType
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSetClientMatchType( MTcTestContext& aContext )
...
#endif // TCMDSETCLIENTMATCHTYPE_H
