...
#ifndef __TCMDCHANNEL_H__
#define __TCMDCHANNEL_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "Channel" functionality.
 */
class TCmdChannel
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdChannel( MTcTestContext& aContext )
