...
#ifndef TCMDAUTHENTICATE_H
#define TCMDAUTHENTICATE_H
...
// CLASS DEFINITION
/**
 * Command class responsible for "Authenticate" functionality.
 */
class TCmdAuthenticate
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdAuthenticate( MTcTestContext& aContext )
