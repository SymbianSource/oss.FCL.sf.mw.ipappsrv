...
#ifndef __TCMDUPDATEPROFILE_H__
#define __TCMDUPDATEPROFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "UpdateProfile" functionality.
 */
class TCmdUpdateProfile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUpdateProfile( MTcTestContext& aContext )
