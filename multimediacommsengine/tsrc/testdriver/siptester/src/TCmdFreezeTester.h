...
#ifndef __TCMDFREEZETESTER_H__
#define __TCMDFREEZETESTER_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "FreezeTester" functionality.
 */
class TCmdFreezeTester
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdFreezeTester( MTcTestContext& aContext )
