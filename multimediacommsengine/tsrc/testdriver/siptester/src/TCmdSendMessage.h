...
#ifndef __TCMDSENDMESSAGE_H__
#define __TCMDSENDMESSAGE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendMessage" functionality.
 */
class TCmdSendMessage
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendMessage( MTcTestContext& aContext )
