...
#ifndef __TCMDSENDSUBSCRIBE_H__
#define __TCMDSENDSUBSCRIBE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendSubscribe" functionality.
 */
class TCmdSendSubscribe
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendSubscribe( MTcTestContext& aContext )
