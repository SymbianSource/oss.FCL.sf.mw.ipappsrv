...
#ifndef __TCMDSENDBYE_H__
#define __TCMDSENDBYE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendBye" functionality.
 */
class TCmdSendBye
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendBye( MTcTestContext& aContext )
