...
#ifndef TCMDREMOVEALLUSERFROMCLIENTRESOLVERCENREP_H
#define TCMDREMOVEALLUSERFROMCLIENTRESOLVERCENREP_H
...
// CLASS DEFINITION
/**
 * Command class responsible for removing all user from cenrep
 * used by SIP 2G Client Resolver plug-in.
 */
class TCmdRemoveAllUserFromClientResolverCenRep
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdRemoveAllUserFromClientResolverCenRep( MTcTestContext& aContext )
...
#endif // TCMDREMOVEALLUSERFROMCLIENTRESOLVERCENREP_H
