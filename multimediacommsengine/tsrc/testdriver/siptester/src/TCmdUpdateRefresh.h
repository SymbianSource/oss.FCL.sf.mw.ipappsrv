...
#ifndef __TCMDUPDATEREFRESH_H__
#define __TCMDUPDATEREFRESH_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "UpdateRefresh" functionality.
 */
class TCmdUpdateRefresh
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUpdateRefresh( MTcTestContext& aContext )
