...
#ifndef __TCMDDISABLEPROFILE_H__
#define __TCMDDISABLEPROFILE_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "DisableProfile" functionality.
 */
class TCmdDisableProfile
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdDisableProfile( MTcTestContext& aContext )
...
#endif // __TCMDDISABLEPROFILE_H__
