...
#ifndef __TCmdGetEventState_H__
#define __TCmdGetEventState_H__
...
class TCmdGetEventState
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetEventState( MTcTestContext& aContext )
