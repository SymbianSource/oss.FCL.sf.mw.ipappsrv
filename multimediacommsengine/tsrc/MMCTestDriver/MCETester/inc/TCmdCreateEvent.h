...
#ifndef __TCmdCreateEvent_H__
#define __TCmdCreateEvent_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for creating an outgoing event
 */
class TCmdCreateEvent
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdCreateEvent( MTcTestContext& aContext )
