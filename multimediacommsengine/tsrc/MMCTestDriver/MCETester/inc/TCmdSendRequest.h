...
#ifndef __TCmdSendRequest_H__
#define __TCmdSendRequest_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendRequest" functionality.
 */
class TCmdSendRequest
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendRequest( MTcTestContext& aContext ) :
