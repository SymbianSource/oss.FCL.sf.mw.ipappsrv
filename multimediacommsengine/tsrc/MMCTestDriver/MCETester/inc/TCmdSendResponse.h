...
#ifndef __TCmdSendResponse_H__
#define __TCmdSendResponse_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendResponse" functionality.
 */
class TCmdSendResponse
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendResponse( MTcTestContext& aContext ) :
