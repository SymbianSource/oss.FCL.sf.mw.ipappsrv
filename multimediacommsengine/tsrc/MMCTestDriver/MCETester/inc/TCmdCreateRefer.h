...
#ifndef __TCmdCreateRefer_H__
#define __TCmdCreateRefer_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "CreateRefer" functionality.
 */
class TCmdCreateRefer
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdCreateRefer( MTcTestContext& aContext )
