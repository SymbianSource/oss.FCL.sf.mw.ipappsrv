...
#ifndef __TCmdSetObserver_H__
#define __TCmdSetObserver_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SetObserver" functionality.
 */
class TCmdSetObserver
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSetObserver( MTcTestContext& aContext ) :
