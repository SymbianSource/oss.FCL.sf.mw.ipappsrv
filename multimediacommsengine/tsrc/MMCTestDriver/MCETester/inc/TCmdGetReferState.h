...
#ifndef __TCmdGetReferState_H__
#define __TCmdGetReferState_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "GetReferState" functionality.
 */
class TCmdGetReferState
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetReferState( MTcTestContext& aContext )
