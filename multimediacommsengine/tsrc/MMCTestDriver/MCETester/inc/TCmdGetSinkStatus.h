...
#ifndef __TCMDGETSINKSTATUS_H__
#define __TCMDGETSINKSTATUS_H__
...
class TCmdGetSinkStatus
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdGetSinkStatus( MTcTestContext& aContext )
