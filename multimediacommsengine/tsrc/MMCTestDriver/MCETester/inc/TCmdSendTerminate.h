...
#ifndef __TCmdSendTerminate_H__
#define __TCmdSendTerminate_H__
...
class TCmdSendTerminate
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendTerminate( MTcTestContext& aContext )
