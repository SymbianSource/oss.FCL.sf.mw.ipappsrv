...
#ifndef __TCmdSendNotify_H__
#define __TCmdSendNotify_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for sending a notification related
 * to incoming event.
 */
class TCmdSendNotify
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendNotify( MTcTestContext& aContext )
