...
#ifndef __TCmdRemoveCodec_H__
#define __TCmdRemoveCodec_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "RemoveCodec" functionality.
 */
class TCmdRemoveCodec
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdRemoveCodec( MTcTestContext& aContext )
    ...
    private: // Helper methods
        ...
        CMceAudioCodec* GetAudioCodecCloneL( const TDesC8& aParamCodecName );

	};

#endif // __TCmdRemoveCodec_H__