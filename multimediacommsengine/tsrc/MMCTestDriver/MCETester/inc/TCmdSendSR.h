...
#ifndef __TCmdSendSR_H__
#define __TCmdSendSR_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "TCmdSendSR" functionality.
 */
class TCmdSendSR
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendSR( MTcTestContext& aContext )
