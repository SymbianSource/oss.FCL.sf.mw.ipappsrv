...
#ifndef __TCMDSendRegister_H__
#define __TCMDSendRegister_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SendRegister" functionality.
 */
class TCmdSendRegister
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSendRegister( MTcTestContext& aContext )
