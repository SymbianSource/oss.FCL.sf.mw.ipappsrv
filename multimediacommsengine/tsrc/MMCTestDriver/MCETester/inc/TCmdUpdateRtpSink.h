...
#ifndef __TCmdUpdateRtpSink_H__
#define __TCmdUpdateRtpSink_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "TCmdUpdateRtpSink" functionality.
 */
class TCmdUpdateRtpSink
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdUpdateRtpSink( MTcTestContext& aContext )
