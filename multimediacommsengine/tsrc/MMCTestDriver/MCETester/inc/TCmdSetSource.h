...
#ifndef __TCmdSetSource_H__
#define __TCmdSetSource_H__
...
// CLASS DEFINITION
/**
 * Command class responsible for "SetSource" functionality.
 */
class TCmdSetSource
	...
	public:	// Constructors and destructor
		 ...
		 */
		TCmdSetSource( MTcTestContext& aContext )
