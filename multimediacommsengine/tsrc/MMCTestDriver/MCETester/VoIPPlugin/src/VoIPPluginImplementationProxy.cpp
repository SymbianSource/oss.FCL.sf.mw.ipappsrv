...
* Contributors:
*
* Description:    VoIPPluginImplementationProxy implementation
*
*/
...
// MACROS
#define SSC_VOIPPLUGIN_DEBUG_PRINT1( a )   RDebug::Print( a )
...
const TImplementationProxy Implementations[] = 
	{
	IMPLEMENTATION_PROXY_ENTRY(	0x10202870,	CVoIPPlugin::NewL )
	};
...
EXPORT_C const TImplementationProxy* ImplementationGroupProxy( TInt& aTableCount )
    {
    SSC_VOIPPLUGIN_DEBUG_PRINT1( _L("VoIPPlugin ImplementationGroupProxy"));
